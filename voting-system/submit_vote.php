...
session_start();
if(empty($_POST['lan'])){
    $error="<center><h4><font color='#dd6300'>Please select a language to vote!</h4></center></font>";
    include"voter.php";
    exit();
}
...
if(mysqli_num_rows($sql) > 0) {
    $msg="<center><h4><font color='#ff7300'>You have already voted, No need to vote again</h4></center></font>";
    include 'voter.php';
    exit();
}
